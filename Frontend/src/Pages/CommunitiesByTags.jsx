...
const CommunitiesByTags = () => {
    ...
    return (
        <section className='min-h-screen text-white py-4 md:py-8 gap-4 md:gap-8 flex flex-col px-4 md:px-8 max-h-fit w-full lg:w-[calc(100%-330px)] bg-gradient-to-r from-[#0A0B10] to-black dark:bg-gradient-to-r dark:from-gray-300 dark:to-gray-300'>
