...
const profile = () => {
    ...
    return (
        <section className='bg-gradient-to-r from-[#0A0B10] to-black dark:bg-gradient-to-r dark:from-gray-300 dark:to-gray-300 h-full w-full lg:w-[calc(100%-330px)] p-6 flex-col'>
            <div className='rounded-md bg-[#0A0B10] dark:bg-gray-300 h-full rounded-[20px] flex flex-col p-6 mt-4'>
                <div className='justify-between items-start mb-4 py-1'>
                    ...
                    <button className='bg-custom-gradient text-[white] font-bold py-2 px-4 rounded transition-all duration-300 hover:scale-105 hover:shadow-lg hover:shadow-orange-500/30'><Link to="/editProfile">Edit Profile</Link></button>
                </div>
                <div className='mt-4 '>
            ...
            <div className='min-h-screen text-white py-8 gap-8 flex flex-col px-8 max-h-fit w-full  bg-gradient-to-r from-[#0A0B10] to-black dark:bg-gradient-to-r dark:from-gray-300'>
