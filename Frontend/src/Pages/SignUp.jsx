            ...
            <form className='bg-[#FAF7F8] w-[90%] h-4/5 max-w-[450px] absolute -translate-x-2/4 -translate-y-2/4  text-center mt-5 pt-[50px] pb-[70px] px-[60px] rounded-[20px] left-2/4 top-2/4'>
                ...
                <div class='input-group'>
                    <div className='bg-[#b1b2b5] flex items-center mx-0 my-[15px] rounded-[3px]'>
                        <input type="text" placeholder="Name" className='bg-transparent w-full px-[15px] py-[18px] border-0 outline-none placeholder-black'/>
                    </div>
                    <div className='bg-[#b1b2b5] flex items-center mx-0 my-[15px] rounded-[3px]'>
                        <input type="text" placeholder="Username" className='bg-transparent w-full px-[15px] py-[18px] border-0 outline-none placeholder-black'/>
                    </div>
                    <div className='bg-[#b1b2b5] flex items-center mx-0 my-[15px] rounded-[3px]'>
                    ...
                    <div className='bg-[#b1b2b5] flex items-center mx-0 my-[15px] rounded-[3px]'>
                        <input type="password" placeholder="Confirm Password" className='bg-transparent w-full px-[15px] py-[18px] border-0 outline-none placeholder-black'/>
                    </div>
                ...
                <div class="btn-field" className='w-full mt-10;'>
                    <button className='text-xl basis-[48%] h-10 w-6/12 bg-[#21C7E7] rounded-[20px] border-0 outline-none' type="button" id="signUpBtn">Sign Up</button>
                </div>
            </form>
        </section>
    )
