...
const ExpandableCard = ({ title, author, asked, votes, comments, views, tags, id, imgSrc }) => {
    ...
    return (
        ...
        <div id={id} className='p-4 sm:p-6 rounded-lg shadow-md bg-[#0B0D12] dark:bg-gray-400 transition-all duration-200 hover:shadow-lg'>
            <div className="flex flex-col sm:flex-row justify-between items-start sm:items-center mb-3">
                <div className="">
                    <Link to={`/question/${id}`} className="block">
                        <h1 className='text-sm lg:text-base font-semibold pr-6 text-wrap w-[300px] sm:w-auto hover:text-purple-400 dark:hover:text-purple-300 transition-colors leading-tight'>
                            {title || "Title Here"}
                        </h1>
                    </Link>
                </div>
