  ...
  return (
    <div id={id} className='p-6 rounded-lg shadow-md bg-[#0B0D12]'>
        <div className="flex mb-3 justify-between">
            <h1 className='text-lg font-semibold pr-6 max-[1500px]:text-[16px]'>{tittle || "The Lightning Component c:LWC_PizzaTracker generated invalid output for field status. Error How to solve this"}</h1>
