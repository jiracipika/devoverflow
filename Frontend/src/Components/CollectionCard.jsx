...
const CollectionCard = ({ question }) => {
  return (
    <div className="p-6 rounded-lg shadow-md bg-[#0B0D12]">
      {/* Question Title and Star Icon */}
      <div className="flex mb-3 justify-between">
        <h3 className="text-lg font-semibold pr-6">{question.title}</h3>
      ...
      <div className="flex justify-between items-center text-gray-400 text-sm mt-3">
        ...
        <div className="flex items-center space-x-2">
          <img src={question.userPic} alt="User" className="w-8 h-8 rounded-full" />
          <span className="text-white font-semibold">{question.userName}</span>
          <span className="text-gray-500 text-xs">• asked 3 mins ago</span>
        </div>
